...
/**
 * This class allows the user to edit a trip from the trip list.
 * @param bEdit is a button that uses an edit button listener to add a edit an existing trip with new, valid trip details.
 * @param bDelete allows the user to delete a trip record from the trip list.
 * @param bCancel is a button that exits the user from the current screen
 * @param thisAcc maintains the same user for additions to the trip list.
 * @param thisTDS  maintsins the trip display screen for the user.
 * @param thisATS is the add trip screen functionality.
*/
...
public class EditTripNavigation extends JFrame {
    ...
    } // public EditTripNavigation(TripDisplayScreen tds, Account acc) end
      // (constructor)
    ...
    /*Action Listener for the delete button to delete a trip */
    ...
    /*Action Listener for the edit button to edit trip details */
    ...
    /* Close Button Action Listener to bring the user back to the Welcome Screen)*/
