...
public class AddTripScreen extends JFrame {
     ...
     * @param bAddTrip is a button that uses an add button listener to add a new, valid trip to the trip list.
    ...
    private class AddBtnListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e) 
        {
            ...
            {
                errorMsg.setText("Insufficient funds for Trip.");
            }
    ...
    /*Close button that takes the user back to the main screen */
