...
public class WelcomeScreen extends JFrame {
    ...
    public WelcomeScreen() {
        ...
        /***accList really should be reading from and writing to a file so it saves all account 
        ...
        loginMsg = new JLabel("");
        loginMsg.setForeground(new Color(237,28,36));
        innerPnl.add(loginMsg);
    ...
    private class LoginBtnListener implements ActionListener
    {
        ...
        {   
            ...
            for (int a = 0; a < accList.size(); a++) {
                /* Since JPasswordfield doesn't allow use of getText() and getPassword() returns char array, 
                String.valueOf(pass.getPassword()) is used because it converts that to a regular String */    
            ...
            if(valid == false) {
                loginMsg.setText("Account not found. Please Sign Up.");
            }
    ...
    private class SignUpBtnListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            //temporarily letting you get to other window using admin account for testing the program easily
