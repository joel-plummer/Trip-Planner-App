...
public class TripDisplayScreen extends JFrame {
    ...
    public TripDisplayScreen(WelcomeScreen ws, Account acc) {
        ...
        // ========================================//
        // There should be a listener for when this is changed, similar to customization
        // in settings
        ...
        pnl1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "DAY 1 TRIPS",
                TitledBorder.LEFT, TitledBorder.TRAILING));
        pnl1.setBackground(Color.LIGHT_GRAY);

        // SETTING UP TABLE FOR TAB 1 (DAY 1)
        TableData day1Table = new TableData(pnl1); // created this class to prevent chunky repetitive code. Creates a
                                                   // table

        // ADDING ELEMENTS TO TABLE
        // format: "Trip Name", "Bus Type", "Bus ID#", "# of People", "Trip ID#",
        // "Time", "Trip Completed?"
        // placeholder data to fill up table, should come from the account instead maybe
        // from an arraylist
        ...
        pnl2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "DAY 2 TRIPS",
                TitledBorder.LEFT, TitledBorder.TRAILING));
        pnl2.setBackground(Color.LIGHT_GRAY);

        // SETTING UP TABLE FOR TAB 2 (DAY 2)
        TableData day2Table = new TableData(pnl2); // created this class to prevent chunky repetitive code. Creates a
                                                   // table
        ...
        pnl3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "DAY 3 TRIPS",
                TitledBorder.LEFT, TitledBorder.TRAILING));
        pnl3.setBackground(Color.LIGHT_GRAY);

        // SETTING UP TABLE FOR TAB 3 (DAY 3)
        TableData day3Table = new TableData(pnl3); // created this class to prevent chunky repetitive code. Creates a
                                                   // table
        ...
        pnl4.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "DAY 4 TRIPS",
                TitledBorder.LEFT, TitledBorder.TRAILING));
        pnl4.setBackground(Color.LIGHT_GRAY);

        // SETTING UP TABLE FOR TAB 4 (DAY 4)
        TableData day4Table = new TableData(pnl4); // created this class to prevent chunky repetitive code. Creates a
                                                   // table
        ...
        pnl5.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "DAY 5 TRIPS",
                TitledBorder.LEFT, TitledBorder.TRAILING));
        pnl5.setBackground(Color.LIGHT_GRAY);

        // SETTING UP TABLE FOR TAB 5 (DAY 5)
        TableData day5Table = new TableData(pnl5); // created this class to prevent chunky repetitive code. Creates a
                                                   // table
        ...
        pnl6.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "DAY 6 TRIPS",
                TitledBorder.LEFT, TitledBorder.TRAILING));
        pnl6.setBackground(Color.LIGHT_GRAY);

        // SETTING UP TABLE FOR TAB 6 (DAY 6)
        TableData day6Table = new TableData(pnl6); // created this class to prevent chunky repetitive code. Creates a
                                                   // table
        ...
        pnl7.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "DAY 7 TRIPS",
                TitledBorder.LEFT, TitledBorder.TRAILING));
        pnl7.setBackground(Color.LIGHT_GRAY);

        // SETTING UP TABLE FOR TAB 7 (DAY 7)
        TableData day7Table = new TableData(pnl7); // created this class to prevent chunky repetitive code. Creates a
                                                   // table
        ...
        pnl8.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "SETTINGS",
