...
public class WelcomeScreen extends JFrame {
    ...
    private String path = System.getProperty("user.dir") + "/database/Accounts.txt";
    ...
    public WelcomeScreen() {
        ...
        /**
         * This loads created accounts from the file to an account list
         */
        if (accEmpty == false) {
            String accFile = path;
            loadAccount(accFile);
        ...
        try {        
            ...
            // active folder)
            icon = new ImageIcon(System.getProperty("user.dir") + "/pics/planner-icon.png");
            icon2 = icon.getImage();
            setIconImage(icon2);
            System.out.println("Planner icon has loaded.");
        } catch (NullPointerException e) {
            System.out.println("Planner icon did not load.");
        }
        ...
        /**
         * This creates infrastructure to display an error message when neecessary.
         */
    ...
    /**
      * This creates and updates an account's save file
      */    
    public void createAccData(Account a) {
        accData = new File(System.getProperty("user.dir") + "/database/" + a.getUsername() + "_data.txt");
    ...
    /**
     * This deletes account's save file 
     */
    public void deleteAccData(Account a) {
        File f = new File(System.getProperty("user.dir") + "/database/" + a.getUsername() + "_data.txt");
        f.delete();
    }

    /**
     * This gets the file path for the file listing all existing accounts.
     * @return the account's file path
     */
    ...
    /**
     * This loads the data for all accounts in the system
     */
    ...
    /**
     * This loads the data for a given account in the system
     */    
    ...
    /**
     * This updates given information in the Accounts.txt file
     */
    ...
    /**
     * This updates the Welcome Screen to display the desired theme
     */
    ...
    private class LoginBtnListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (inputEmpty) {
                ...
                /**
                 *  Error message if the account information from the text fields is not found.
                 */
                if (valid == false) {
                    errorMsg.setForeground(new Color(237, 28, 36));
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (inputEmpty) {
                ...
                try {
                    ...
                    /**
                     * This checks if account, user, or password already exists 
                     */
