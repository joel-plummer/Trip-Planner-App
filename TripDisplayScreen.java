...
public class TripDisplayScreen extends JFrame {
    ...
    public TripDisplayScreen(WelcomeScreen ws, Account acc) {
        ...
        /*
         * thisAcc.addTripToDay(2, new Trip("Quick Trip 1", new Bus(BusType.Small), 8,
         * "13", "30"));
         * thisAcc.addTripToDay(2, new Trip("Holland Students", new Bus(BusType.Medium),
         * 17, "03", "30"));
         * thisAcc.addTripToDay(2, new Trip("Ochi Tourists", new Bus(BusType.Luxurious),
         * 36,"03", "00"));
         * thisAcc.addTripToDay(2, new Trip("Mobay Tourists", new
         * Bus(BusType.Luxurious), 40,"00", "43"));
         * thisAcc.addTripToDay(2, new Trip("Quick Trip 2", new Bus(BusType.Medium),
         * 23,"00", "10"));
         * thisAcc.addTripToDay(2, new Trip("Quick Trip 4", new Bus(BusType.Medium),
         * 16,"03", "56"));
         */
    ...
    public void updateInfo() {
        ...
        info.setText("Total Budget: $" + accBudget + "\tTotal Bus cost: $" + accRemaining +
    ...
    // Ensures that each trip in the list of trips are added to the table for the
    // given day
    ...
    // Stores data from trip as an array and passes it to a method to add it to that
    // day's table
